...
ICSwapChain::ICSwapChain(ICDevice &deviceRef, VkExtent2D extent)
...
VkResult ICSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult ICSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                           uint32_t *imageIndex) {
...
void ICSwapChain::waitForFrameFence(uint32_t *imageIndex) {
...
void ICSwapChain::immediateSubmitCommandBuffers(
    const VkCommandBuffer buffer, std::function<void(VkCommandBuffer cmd)> &&function) {
    ...
    VK_CHECK(vkWaitForFences(device.device(), 1, &immFence, VK_TRUE, 999999999));
}

void ICSwapChain::createSwapChain() {
...
void ICSwapChain::createImageViews() {
...
void ICSwapChain::createRenderPass() {
...
void ICSwapChain::createFramebuffers() {
...
void ICSwapChain::createDepthResources() {
...
void ICSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR ICSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR ICSwapChain::chooseSwapPresentMode(
...
VkExtent2D ICSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat ICSwapChain::findDepthFormat() {
